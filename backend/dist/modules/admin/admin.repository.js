import { getOrganizationsRef, getOrganizationRef, getInvitesRef, getInviteRef, } from '../../infrastructure/database/collections.js';
...
export async function findOrganizationsByCreator(uid) {
    let orgsSnapshot;
    try {
...
export async function createAdminInvite(uid, input, frontendUrl) {
...
export async function findInvitesByOrgIds(orgIds, frontendUrl, limit = 50) {
    if (orgIds.length === 0) {
        return [];
    }

...
import { getOrganizations, createOrganization, createInvite, getInvites, getSuperAdmins, addSuperAdmin, removeSuperAdmin, bootstrapSuperAdmin, devSetSuperAdmin, checkSuperAdminStatus, } from './admin.service.js';
import { createOrgSchema, createAdminInviteSchema, setSuperAdminSchema, bootstrapSuperAdminSchema, } from './admin.schema.js';
export const adminRoutes = async (fastify) => {
    ...
    fastify.post('/admin/super-admin', async (request, reply) => {
        await requireSuperAdmin(request, reply);
    ...
    fastify.delete('/admin/super-admin/:uid', async (request, reply) => {
        await requireSuperAdmin(request, reply);
    ...
    fastify.post('/bootstrap/super-admin', async (request, reply) => {
    ...
    if (config.NODE_ENV !== 'production') {
        ...
        fastify.post('/dev/set-super-admin', async (request, reply) => {
            const body = setSuperAdminSchema.parse(request.body);
            try {

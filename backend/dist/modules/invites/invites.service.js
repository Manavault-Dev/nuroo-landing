import { createOrgInvite, findOrgInvite, findInvite, findParentInvite, incrementInviteUsage, createParentInvite, findOrganization, findOrgMember, createOrgMembership, upsertSpecialist, linkChildToOrg, findOrCreatePersonalOrg, } from './invites.repository.js';
...
export async function createSpecialistOrgInvite(orgId, createdBy, input) {
    return createOrgInvite(orgId, input.role, createdBy, input.expiresInDays, input.maxUses);
}
export async function joinOrganization(uid, email, input) {
...
export async function acceptInviteCode(uid, email, input) {
...
export async function createSpecialistParentInvite(uid, email) {
...
export async function validateParentInviteCode(code) {
...
export async function useParentInviteCode(code, childId, parentUid) {
    const normalizedCode = code.trim().toUpperCase();

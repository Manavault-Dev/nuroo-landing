...
function validateInviteActive(isActive) {
...
function buildSpecialistData(uid, email, orgId, role, now) {
    return {
        uid,
        email: email || '',
...
export const invitesAcceptRoute = async (fastify) => {
...
//# sourceMappingURL=invitesAccept.js.map
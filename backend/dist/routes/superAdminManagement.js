...
function removeSuperAdminClaim(currentClaims) {
    const updatedClaims = { ...currentClaims };
    delete updatedClaims.superAdmin;
    return updatedClaims;
}
function transformSuperAdmin(user) {
    return {
        uid: user.uid,
        email: user.email || '',
...
function buildFallbackSuperAdmin(currentUser) {
    return {
        uid: currentUser.uid,
...
async function listSuperAdminsWithFallback(auth, currentUser) {
    try {
...
export const superAdminManagementRoute = async (fastify) => {
...
//# sourceMappingURL=superAdminManagement.js.map
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gentle-50 via-white to-primary-50 dark:from-gray-950 dark:via-gray-900 dark:to-primary-950/20 pt-24 md:pt-28 min-w-0">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="hero-orb-1 animate-float-slow absolute -top-24 -left-24 w-[480px] h-[480px] bg-primary-200/35 dark:bg-primary-700/15 rounded-full blur-3xl" />
        <div className="hero-orb-2 animate-float-medium absolute top-1/3 -right-24 w-96 h-96 bg-secondary-200/30 dark:bg-secondary-700/15 rounded-full blur-3xl" />
        <div className="hero-orb-3 animate-float-slow absolute -bottom-24 left-1/3 w-80 h-80 bg-teal-200/25 dark:bg-teal-700/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container-custom relative z-10 min-w-0 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center min-w-0">
          ...
          <div className="text-center lg:text-left min-w-0">
            ...
            {/* Headline — одна мысль */}
            <h1
              className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-5 leading-tight break-words transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            {/* Subtitle — коротко */}
            <p
              className={`text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 md:mb-8 max-w-xl leading-relaxed break-words transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            {/* App buttons */}
            <div
              className={`flex flex-wrap justify-center lg:justify-start items-center gap-4 mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            {/* Социальное доказательство — акцент */}
            <div
              className={`inline-flex items-center gap-3 px-4 py-3 rounded-xl bg-primary-50 dark:bg-primary-900/30 border border-primary-100 dark:border-primary-800/50 min-w-0 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
